...
// explicitly granted (submenu can_view) — mirroring the sidebar, so anything
...
<div class="content pb-0">
    ...
    <div class="dashboard-grid">
        <?php if ($sec['finance']): ?>
            <?php clinic_dash_chart('chartRevenue', 'Revenue Trend — Last 7 Days', 'Payments', 7, 'lg', 'chart_revenue_trend'); ?>
            <?php clinic_dash_chart('chartRevenueDonut', 'Revenue by Payment Method', 'All time', 5, 'lg', 'chart_revenue_method'); ?>
        <?php endif; ?>
        <?php if ($sec['patients']): ?>
            <?php clinic_dash_chart('chartPatients', 'New Patients — Last 7 Days', 'Registrations', 5, 'lg', 'chart_patients'); ?>
    ...
    <?php if ($sec['appointments']): ?>
        ...
        <div class="dashboard-grid">
            ...
            <?php clinic_dash_chart('chartApptStatus', 'Appointment Status — Today', 'Breakdown', 5, 'md', 'chart_appt_status'); ?>
        </div>
    <?php endif; ?>
    <?php if ($sec['visits']): ?>
        <!-- ============ VISITS ============ -->
        <div class="dashboard-grid">
            ...
            <?php clinic_dash_chart('chartDoctors', 'Appointments by Doctor — Today', 'Top doctors', 6, 'md', 'chart_doctors_appts'); ?>
        </div>
        <div class="dashboard-grid">
            <?php clinic_dash_chart('chartVisits', 'Visits Trend — Last 7 Days', 'Count', 6, 'md', 'chart_visits_trend'); ?>
            <div class="dash-span-6">
                <div class="card clinic-card h-100 dash-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
    ...
    <?php if ($sec['pharmacy']): ?>
        <!-- ============ PHARMACY ============ -->
        <div class="dashboard-grid">
            <?php clinic_dash_chart('chartPharmacy', 'Pharmacy Sales — Last 7 Days', 'Revenue', 6, 'md', 'chart_pharmacy_trend'); ?>
            <div class="dash-span-6">
                <div class="card clinic-card h-100 dash-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
